<?php
  ...
  //
  // Menus
  // Add classes to menu <li>s
  // function add_item_classes($classes, $item, $args) {
  ...
  //     return $classes;
  // }
  // add_filter("nav_menu_css_class", "add_item_classes", 1, 3);

  // Add classes to menu <a>s
  // function add_link_attributes($atts, $item, $args) {
  ...
  //     return $atts;
  // }
  // add_filter("nav_menu_link_attributes", "add_link_attributes", 10, 3);
